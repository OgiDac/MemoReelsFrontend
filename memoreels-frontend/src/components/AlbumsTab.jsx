...
function AlbumCard({
  ...
  // 🔸 Prefer API field `coverThumbUrl`; fall back to older `coverUrl` if present.
  const coverUrl = album.coverThumbUrl || album.coverUrl || "";
      ...
      >
        {coverUrl ? (
          <img
            ...
            loading="lazy"
            onError={(e) => {
              // graceful fallback if URL expired/broken
